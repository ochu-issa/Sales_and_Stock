              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php   
                    $no = 1;
                    $select_sel = mysqli_query($conn, "select distinct invoice from selltable order by sellid desc");
                 ...
                 <tr>
                   ...
                   <th  style="background: #ffc108; color: white;">
                     <?php   
                       $totalquery = "SELECT sum(quantity) FROM selltable";
                   ...
                   <th colspan="2" style="background: #007bff; color: white;">
                     <?php   
                       $totalquery = "SELECT sum(amount) FROM selltable";
                       $run = mysqli_query($conn, $totalquery);
                       for ($i=0; $cxz = mysqli_fetch_assoc($run); $i++) { 
                         $tmon = $cxz['sum(amount)'];
