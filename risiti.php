...
$braid = $tcuser['branchid'];
$seletobr = mysqli_query($conn, "select branchname from branchtable where branchid = '$braid'");
// $selfrompro2 = mysqli_query($conn, "select * from producttable where productid = '$proid2'");
$have3 = mysqli_fetch_assoc($seletobr);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Nyumbani <?php echo $inv; ?></a></li>
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  <address>
                    ...
                    P.O.BOx 2022,<br>
                    <b><?php echo $have3['branchname']; ?></b><br>
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="printi-risiti.php?<?php echo $inv; ?>" target="" class="btn btn-warning"><i class="fas fa-print"></i> Printi Risiti</a>
